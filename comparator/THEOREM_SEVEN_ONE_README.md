...
definition-level bridge to the production Phase-28 theorem. Comparator, rather
than a source-code diff, is responsible for checking that the two exported
theorem types are identical.
...
`Quot.sound` for both solution declarations. The challenge warnings about
