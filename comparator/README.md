...
| TheoremSevenOne | T5: the exact positive-integer xi normalization seam, literal three-sector centered-xi coefficient asymptotic, and Cauchy derivative bounds through order six (3) | —; all trusted definitions are embedded in the Mathlib-only Challenge |

The `TheoremSevenOne` topic is the Palomar-facing package for the analytic
